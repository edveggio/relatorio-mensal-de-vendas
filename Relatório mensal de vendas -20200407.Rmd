...
```{r vendas, echo=FALSE}
pipe_FunildeVendas<- read_delim("pipe Funil de Vendas - 20200413.csv", 
...
pipe_FunildeVendas$"Trimestre de abertura" <- quarters(pipe_FunildeVendas$`Data de fechamento`)
